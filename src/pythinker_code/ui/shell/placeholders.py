...
from pythinker_code.utils.envvar import get_env_int
from pythinker_code.utils.logging import logger
from pythinker_code.utils.media_tags import wrap_media_part
from pythinker_code.utils.string import random_string
from pythinker_code.wire.types import ContentPart, ImageURLPart, TextPart

_DEFAULT_PROMPT_CACHE_ROOT = get_share_dir() / "prompt-cache"
_LEGACY_PROMPT_CACHE_ROOT = Path("/tmp/pythinker")
