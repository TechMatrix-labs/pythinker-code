...
from pythinker_core.message import ContentPart, ToolCall
from pythinker_core.utils.jsonschema import deref_json_schema
...
class DisplayBlock(BaseModel, ABC):
    ...
    Unlike `ContentPart`, Pythinker Core users may directly subclass `DisplayBlock` to define custom
