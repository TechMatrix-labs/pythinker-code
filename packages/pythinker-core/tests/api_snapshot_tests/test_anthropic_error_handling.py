...
# ---------------------------------------------------------------------------
# Shared convert_httpx_error (pythinker_core.chat_provider)
# ---------------------------------------------------------------------------


class TestConvertHttpxError:
    """The shared convert_httpx_error utility must correctly map every httpx
    exception subclass to the corresponding Pythinker Core ChatProviderError."""
...
class TestStreamingErrorPropagation:
    ...
    and convert to Pythinker Core error types - not let them leak to the caller."""
