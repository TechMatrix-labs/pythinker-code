...
```sh
# Debian / Ubuntu
curl -LO https://github.com/mohamed-elkholy95/Pythinker-Code/releases/download/v0.21.0/pythinker-code_0.21.0_amd64.deb
curl -LO https://github.com/mohamed-elkholy95/Pythinker-Code/releases/download/v0.21.0/pythinker-code_0.21.0_amd64.deb.sha256
sha256sum -c pythinker-code_0.21.0_amd64.deb.sha256
...
```sh
bash packages/linux-installer/build.sh 0.21.0
```

Outputs to `dist/`:

- `pythinker-code_0.21.0_amd64.deb`
- `pythinker-code-0.21.0.x86_64.rpm`
...
target-triple naming (e.g. `pythinker-0.21.0-x86_64-unknown-linux-gnu.tar.gz`).
