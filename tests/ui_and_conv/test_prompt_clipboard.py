...
from pythinker_code.ui.shell.prompt import PromptMode
from pythinker_code.utils.clipboard import ClipboardResult
...
async def test_question_delegate_expands_placeholders_on_submit() -> None:
    ...
    from pythinker_code.ui.shell.visualize import QuestionPromptDelegate, QuestionRequestPanel
    from pythinker_code.wire.types import QuestionItem, QuestionRequest
