...
from pythinker_code.tools.file.read_media import Params, ReadMediaFile
from pythinker_code.wire.types import ImageURLPart, TextPart, VideoURLPart


async def test_read_image_file(read_media_file_tool: ReadMediaFile, temp_work_dir: HostPath):
...
async def test_read_extensionless_image_file(
    read_media_file_tool: ReadMediaFile, temp_work_dir: HostPath
):
...
async def test_read_video_file(read_media_file_tool: ReadMediaFile, temp_work_dir: HostPath):
...
async def test_read_text_file(read_media_file_tool: ReadMediaFile, temp_work_dir: HostPath):
...
async def test_read_video_file_without_capability(runtime: Runtime, temp_work_dir: HostPath):
