...
async def test_hooks_metadata_in_initialize(temp_work_dir: HostPath, tmp_path: Path) -> None:
...
async def test_wire_hook_subscription_in_initialize(
    temp_work_dir: HostPath, tmp_path: Path
) -> None:
...
async def test_hook_events_fire_during_prompt(temp_work_dir: HostPath, tmp_path: Path) -> None:
...
async def test_pre_tool_use_hook_blocks_tool(temp_work_dir: HostPath, tmp_path: Path) -> None:
