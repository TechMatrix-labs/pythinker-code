...
def test_shell_smoke_multiturn_scripted_echo(tmp_path: Path) -> None:
    ...
    try:
        shell.read_until_contains("Welcome to Pythinker CLI!")
...
def test_shell_session_resume_and_replay(tmp_path: Path) -> None:
    ...
    try:
        first_shell.read_until_contains("Welcome to Pythinker CLI!")
    ...
    try:
        second_shell.read_until_contains("Welcome to Pythinker CLI!")
...
def test_shell_clear_reloads_without_replaying_old_turns(tmp_path: Path) -> None:
    ...
    try:
        ...
        shell.read_until_contains("Welcome to Pythinker CLI!", after=clear_mark)
