...
from pythinker_code.wire.types import Notification, TextPart, ToolCall, TurnBegin, TurnEnd
...
async def test_acp_prompt_cancel_closes_abandoned_approval_stream(
    ...
    session = ACPSession("session-1", PythinkerCLI(soul, runtime, {}), conn)  # type: ignore[arg-type]
