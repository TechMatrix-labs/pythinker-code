...
function readPythinkerCliVersion(): string {
  const fallback = process.env.PYTHINKER_CLI_VERSION ?? "dev";
...
const pythinkerCliVersion = readPythinkerCliVersion();
...
export default defineConfig({
  ...
  define: {
    __PYTHINKER_CLI_VERSION__: JSON.stringify(pythinkerCliVersion),
  },
  resolve: {
    alias: {
