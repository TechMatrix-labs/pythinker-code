...
STATIC_DIR = ROOT / "src" / "pythinker_code" / "web" / "static"

STRICT_VERSION = os.environ.get("PYTHINKER_WEB_STRICT_VERSION", "").lower() in {"1", "true", "yes"}
...
def main() -> int:
    ...
    explicit_expected = os.environ.get("PYTHINKER_WEB_EXPECT_VERSION")
